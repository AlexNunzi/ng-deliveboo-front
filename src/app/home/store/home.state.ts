...
export class HomeState {
  ...
  getTypesStateAction(ctx: StateContext<HomeStateModel>) {
    return this.restaurantApiService.getRestaurantTypes().pipe(
      tap((response: TypesGetInterface) => {
  ...
  getFilteredRestaurantsAction(
    ...
    action: GetFilteredRestaurantsAction
  ) {
    ctx.patchState({
      searchCarriedOut: false,
    });
    return this.restaurantApiService
      .getFilteredRestaurants(action.restaurantsIds)
      .pipe(
        tap((response: RestaurantsGetInterface) => {
          ctx.patchState({
  ...
  getRestaurantMenuAction(
    ctx: StateContext<HomeStateModel>,
    action: GetRestaurantMenuAction
  ) {
    return this.restaurantApiService
      .getRestaurantMenu(action.restaurantSlug)
      .pipe(
        tap((response: RestaurantMenuGetInterface) => {
          ctx.patchState({
